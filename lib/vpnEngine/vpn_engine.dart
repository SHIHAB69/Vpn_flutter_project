...
{
  //native channel
  static final String enventChannelVpnStage = "vpnStage";
  static final String enventChannelVpnStatus = "vpnStatus";
  static final String methodChannelVpnControl = "vpnControl";
  //vpn connection stage snapshot
  static Stream<String> snapshotVpnStage() => EventChannel(enventChannelVpnStage).
   receiveBroadcastStream()
      .cast();

//vpn connection status snapshot

static Stream<VpnStatus?> snapshotVpnStatus() => EventChannel(enventChannelVpnStatus)
    .receiveBroadcastStream()
